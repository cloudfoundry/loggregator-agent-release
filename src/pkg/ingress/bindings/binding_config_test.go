...
var _ = Describe("Drain Param Config", func() {
	...
	It("sets drain filter appropriately", func() {
		testCases := []struct {
			...
			{
				name:     "include-log-source-types= defaults to no filtering",
				url:      "https://test.org/drain?include-log-source-types=",
				expected: nil,
			},
			{
				name:     "exclude-log-source-types= defaults to no filtering",
				url:      "https://test.org/drain?exclude-log-source-types=",
				expected: nil,
			},
			{
				name:     "include-log-source-types=app",
				url:      "https://test.org/drain?include-log-source-types=app",
				expected: NewLogFilter(syslog.LogFilterModeInclude, syslog.LOG_SOURCE_APP),
			},
			{
				name:     "include-log-source-types=app,stg,cell",
				url:      "https://test.org/drain?include-log-source-types=app,stg,cell",
				expected: NewLogFilter(syslog.LogFilterModeInclude, syslog.LOG_SOURCE_APP, syslog.LOG_SOURCE_STG, syslog.LOG_SOURCE_CELL),
			},
			{
				name:     "exclude-log-source-types=rtr,cell,stg",
				url:      "https://test.org/drain?exclude-log-source-types=rtr,cell,stg",
				expected: NewLogFilter(syslog.LogFilterModeExclude, syslog.LOG_SOURCE_RTR, syslog.LOG_SOURCE_CELL, syslog.LOG_SOURCE_STG),
			},
			{
				name:     "exclude-log-source-types=rtr",
				url:      "https://test.org/drain?exclude-log-source-types=rtr",
