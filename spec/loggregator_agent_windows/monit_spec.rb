...
RSpec.describe "Agent Windows Environment" do
  it "renders a full environment" do
    ...
    config = render_monit_config(properties, spec: spec)
  ...
  it "defaults to the job name of the spec" do
    ...
    config = render_monit_config({}, spec: spec)
  ...
  describe "Zone" do
    ...
    it "uses the provided property" do
      ...
      config = render_monit_config(prop, spec: spec)
  ...
  describe "GRPC" do
    it "splits cipher suites separated by a colon" do
      ...
      config = render_monit_config(properties)
  ...
  describe "Bosh DNS is enabled" do
    it "uses bosh links to populate RouterAddr and RouterAddrWithAZ" do
      ...
      properties = {"loggregator_agent" => {"bosh_dns" => true}}
